...
public class ContinuumIslandCatalogueParserTest
{
    ...
    private ContinuumIslandCatalogueParser parser;

    @Before
    public void setUp()
    {
        MockitoAnnotations.initMocks(this);
        parser = new ContinuumIslandCatalogueParser(observationRepository, catalogueRepository,
                continuumIslandRepository, new ContinuumIslandVoTableVisitor(continuumIslandRepository));
    }
    ...
    public class BadFile
    {
        ...
        {
            // Can't test for Continuum Catalogue because there are no mandatory 'boolean' PARAMS
        }
        ...
        public void paramValueCharToolong() throws Exception
        {
            ...
            expectedException.expect(CatalogueParser.MalformedFileException.class);
            expectedException.expectMessage(containsString("Error in PARAM 'imageFile' : "
                    + "Value 'src/test/resources/image/too/long/too/long/too/long/too/long/too/long/too/long/"
        ...
        {
            // Can't test for Continuum Catalogue because there are no mandatory 'int' PARAMS
        }
        ...
        {
            // Can't test for Continuum Catalogue because there are no mandatory 'real' PARAMS
        }
        ...
        {
            // Cant test for Continuum Island Catalogue because there are no mandatory 'float' PARAMS
        }
        ...
        {
            // Can't test for Continuum Catalogue because there are no 'decimal' PARAMS
        }
        ...
        {
            // Can't test for Continuum Catalogue because there are no 'decimal' PARAMS with a width
        }
        ...
        {
            // Can't test for Continuum Catalogue because there are no 'decimal' PARAMS with a precision
        }
        ...
        {
            // Can't test for Continuum Catalogue because there are no 'int' FIELDs with a width
        }
        ...
        {
            // Can't test for Continuum Catalogue because all 'float' FIELDs are 'decimals'
        }
    ...
    {
        return "src/test/resources/catalogue/bad/island/islandCatalogue." + testCase + ".xml";
    }

    private String getPathForGoodTestCase(String testCase)
    {
        return "src/test/resources/catalogue/good/island/islandCatalogue." + testCase + ".xml";
    }
