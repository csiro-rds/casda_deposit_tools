...
import au.csiro.casda.datadeposit.catalogue.spectralline.SpectralLineEmissionVoTableVisitor;
...
/**
 * Tests the SpectalLineEmissionCatalogueParser
 * <p>
 * Copyright 2014, CSIRO Australia All rights reserved.
 */
@RunWith(HierarchicalContextRunner.class)
public class SpectralLineEmissionCatalogueParserTest 
{
    ...
    private SpectralLineEmissionCatalogueParser parser;

    @Before
    public void setUp()
    {
        MockitoAnnotations.initMocks(this);
        parser = new SpectralLineEmissionCatalogueParser(observationRepository, catalogueRepository,
                spectralLineEmissionRepository,
                        new SpectralLineEmissionVoTableVisitor(spectralLineEmissionRepository));
    }
     ...
     */
    @Test
    public void parseValidSpectralLineEmission() throws Exception
    {
     ...
     */
    @Test
    public void parseInvalidSpectralLineEmission() throws Exception
    {
        BufferedReader goldenMasterReader = new BufferedReader(new InputStreamReader(new FileInputStream(
                        TestUtils.getResourceAsFile("spectralline/bad/spectrallineEmissionFailureMessages.txt")),
