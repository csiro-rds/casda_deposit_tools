...
UPDATE ${schema}.catalogue SET level7_active='f' where level7_collection_id IN 
(SELECT id FROM casda.level7_collection WHERE dc_common_id = ${level7DcCommonId?c});

UPDATE ${schema}.catalogue SET entries_table_name = '${schema}.${level7CatalogueName}', version = (version+1), level7_active='t', deposit_state='PROCESSED'
