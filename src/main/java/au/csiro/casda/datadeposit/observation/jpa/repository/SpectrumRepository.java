...
{
    /**
     * Returns the first Spectrum associated with the given Observation (by sbid) and filename
     * 
     * @param sbid
     ...
     * @return a Spectrum
     */
    public Spectrum findByObservationSbidAndFilename(Integer sbid, String filename);

    /**
     * Returns the first Spectrum associated with the given Level7CollectionId and filename
     * 
     ...
     * @return a Spectrum
     */
    public Spectrum findByLevel7CollectionDapCollectionIdAndFilename(long level7CollectionId, String filename);
}
